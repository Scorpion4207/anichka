export const unit12 = () => {
  ...
  // function arrayOutput(array, elemDOM) {
  //   document.querySelector(elemDOM).innerHTML = array;
  //   return array;
  // }

  // document.querySelector('#b-4').addEventListener('click', () => {
  //   arrayOutput(a4[1], '.out-4');
  // });
